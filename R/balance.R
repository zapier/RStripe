...
#' @export
#'
stripe_retrieve_balance <- function(api_key = stripe_api_key()) {
...
#' @export
#'
stripe_retrieve_balance_transaction <- function(api_key = stripe_api_key(), transaction_id) {
...
#' @export
#'
stripe_balance_history <- function(api_key = stripe_api_key(), args=NULL) {
