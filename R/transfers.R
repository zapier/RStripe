...
#' @export
#'
stripe_create_transfer <- function(api_key = stripe_api_key(), args) {
    args <- .metadata(args)
...
#' @export
#'
stripe_retrieve_transfer <- function(api_key = stripe_api_key(), transfer_id) {
...
#' @export
#'
stripe_update_transfer <- function(api_key = stripe_api_key(), transfer_id, args) {
    args <- .metadata(args)
...
#' @export
#'
stripe_cancel_transfer <- function(api_key = stripe_api_key(), transfer_id) {
...
#' @export
#'
stripe_list_transfers <- function(api_key = stripe_api_key(), args=NULL) {
