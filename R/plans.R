...
#' @export
#'
stripe_create_plan <- function(api_key = stripe_api_key(), args) {
...
#' @export
#'
stripe_retrieve_plan <- function(api_key = stripe_api_key(), plan_id) {
...
#' @export
#'
stripe_update_plan <- function(api_key = stripe_api_key(), plan_id, args) {
    args <- .metadata(args)
    link <- paste0("https://api.stripe.com/v1/plans/", plan_id)
    .post(api_key, link, args)
}
...
#' @export
#'
stripe_delete_plan <- function(api_key = stripe_api_key(), plan_id) {
    link <- paste0("https://api.stripe.com/v1/plans/",plan_id)
    .delete(api_key, link)
}
...
#' @export
#'
stripe_list_plans <- function(api_key = stripe_api_key(), args=NULL) {
