...
#' @export
#'
stripe_create_subscription <- function(api_key = stripe_api_key(), customer_id, args) {
...
#' @export
#'
stripe_retrieve_subscription <- function(api_key = stripe_api_key(), customer_id, subscription_id) {
...
#' @export
#'
stripe_update_subscription <- function(api_key = stripe_api_key(), customer_id, subscription_id, args) {
    args <- .metadata(args)
    link <- paste0("https://api.stripe.com/v1/customers/",customer_id, "/subscriptions/",
                   subscription_id)
    .post(api_key, link, args)
...
#' @export
#'
stripe_delete_subscription <- function(api_key = stripe_api_key(), customer_id, subscription_id) {
    link <- paste0("https://api.stripe.com/v1/customers/",customer_id, "/subscriptions/",
                   subscription_id)
    .delete(api_key, link)
}
...
#' @export
#'
stripe_list_subscriptions <- function(api_key = stripe_api_key(), customer_id, args=NULL) {
