...
#' @export
#'
stripe_delete_customer_discount <- function(api_key = stripe_api_key(), customer_id) {
...
#' @export
#'
stripe_delete_subscription_discount <- function(api_key = stripe_api_key(), customer_id, subscription_id) {
